 ...
 */
@Service
public class CoursehttpServicelmpl implements CoursehttpService {

    @Override
    public  String httpRequest(String url, Map<String, String> param, String method, Map<String, String> headers) {
    ...
    @Override
    public String pramHandle(Map<String, String> params) {
    ...
    @Override
    public String doGet(String httpurl, Map<String, String> headers) {
    ...
    @Override
    public void closeConn(BufferedReader br,InputStream is,HttpURLConnection connection){
        if (null != br) {
            try {
                br.close();
            } catch (IOException e) {
