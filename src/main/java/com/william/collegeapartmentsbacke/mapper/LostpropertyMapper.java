...
public interface LostpropertyMapper {
    @Update("insert into coap.Lostproperty (category,pickLocation,pickTime,describes,contactobject,filepath) values (#{category},#{pickLocation},#{pickTime},#{describes},#{contactobject},#{filepath})")
